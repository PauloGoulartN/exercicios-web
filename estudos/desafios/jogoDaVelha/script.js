...
function verificaLinhasXColunas(
    posL1, posL2, posL3,
    posC1, posC2, posC3
) {
...
function encerraJogo(linha, coluna, linhaManual, colManual) {

    verificaLinhasXColunas(
        linha, linha, linha,
        colManual, colManual + 1, colManual + 2
    )

    verificaLinhasXColunas(
        linhaManual, linhaManual + 1, linhaManual + 2,
