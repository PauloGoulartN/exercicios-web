...
function mediaPrecos(marc){
    ...
    let media = somaPreco / cont

    return `A soma dos produtos da marca ${marc} é ${somaPreco} e a média é ${media.toFixed(2)}`
}

console.log(mediaPrecos("Nike"))